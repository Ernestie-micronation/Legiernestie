...
\article{}
La Démocratie Ernestienne Normalienne et Supercool (DENS) est un régime démocratique basé à l'École Normale Supérieure de Paris, mais ouverte à tous. Elle assure l'égalité devant la loi de tous les citoyens sans distinction.
\article{}
...
\article{}
Un citoyen permanent peut être promu citoyen honoraire par un vote à majorité du conseil constitutionnel après avoir siégé au moins un an au conseil  des citoyens permanents. Il conserve alors son statut de citoyen permanent tant qu’il reste étudiant de l’ENS Ulm. Après cela, ce statut devient purement honorifique et prend le statut de citoyen honoraire² (lire “honoraire carré”). Il ne peut y avoir plus de 13 membres honoraires. Un membre pemanent quittant l'ENS devient honoraire².
\article{}
...
\article{}
Dans le cas où il n'y a plus de citoyen permananent (hors honoraires²), les membres élus du conseil constitutionnel ont deux jours pour nommer un citoyen permanent parmi eux. S'ils ne parviennent à se mettre d'accord, un citoyen permanent est tiré au sort parmi le conseil élu. S'il n'existe aucun conseiller constitutionnel, un citoyen permanent est tiré au sort parmi les anciens citoyens.
...
\subarticle{}
Le conseil doit annuler toute décision, en particulier le vote d'une loi, si les $\frac{2}{3}$ de ses membres la jugent anticonstitutionnelle.
\subarticle{}
...
\subarticle{}
Des candidats individuels citoyens peuvent, à tout moment, se présenter au poste de membre élu au conseil constitutionnel. Ils ne pourront briguer une élection que s’ils se signalent au minimum une semaine avant une élection trimestrielle.
\subarticle{}
...
Le conseil constitutionnel se doit de mettre en garde ses membres faisant preuve d’absentéisme, et notamment d’effectuer au moins un rappel à l’ordre, par tous les moyens possibles, une semaine avant le constat de leur absentéisme effectif. 
\subarticle{}
...
\begin{itemize}
    ...
    \item Prise de pouvoir personnelle par un citoyen ou groupe de citoyen ou élément extérieur à la DENS.
\end{itemize}
\article{}
...
\begin{itemize}
    ...
    \item du régime de la propriété, des droits réels et des obligations civiles et commerciales ;
    \item du droit du travail, du droit syndical et de la sécurité sociale.
\end{itemize}
...
\subarticle{}
Tout citoyen est libre de proposer une loi, en déposant le contenu du texte de loi (sous forme d’un message pour une loi courte, ou d’un pdf pour une loi longue) sur le canal “Propositions de lois” du serveur du DENS. Ce texte de loi devra comporter une justification rationnelle précise de son utilité.
\subarticle{}
En cas de non constitutionnalité ou de redondance avec une loi déjà existante ou déjà proposée (dans ce cas l’équivalence entre les propositions de lois doit être démontrée), le conseil constitutionnel peut rejeter le dépôt de la proposition en censurant le message déposé.
La censure du dépôt d’une loi de fait sous les mêmes modalités que la censure d’une QPC (cf \reftarget{QPC}). 
\article{Débats}
\subarticle{}
La présente constitution instaure une assemblée citoyenne (agora), composée de tous les citoyens, sous la forme d’un canal Discord, afin de débattre sur les propositions de lois avant de les soumettre à un vote.
\subarticle{}
...
\subarticle{}
Le conseil constitutionnel peut également, à chaque modification de la proposition de loi, censurer cette proposition sous les mêmes modalités que l’\reftarget{Article 7.1}.
\article{}
...
\subarticle{}
La prise de décision est effectuée par les citoyens à la majorité absolue, par le vote d’une proposition de loi sur le canal vote du Discord.
\subarticle{}
Seuls les citoyens reconnus comme tel avant le début du vote peuvent y prendre part.
\subarticle{}
...
\article{}
Les responsables administratifs sont nommés par le conseil constitutionnel. Le conseil peut révoquer leur mandat à tout moment. Ces responsables peuvent représenter le conseil en organisant des votes et doivent lui rendre compte de chacune de leur intervention officielle.
\article{}
Le secrétaire d'État est chargé de promulguer les textes de loi adoptés, la version révisée de la constitution après chaque modification ou encore le résultat de chaque désignation d’un citoyen ou élection à un poste officiel au journal officiel.
\article{}
Les ambassadeurs servent d'intermédiaires avec les autres nations mais ne peuvent prendre des décisions. Ils doivent rendre compte au conseil de chacune de leurs actions officielles.
\article{}
Le conseil constitutionnel nomme un commissaire général, chargé de veiller à la bonne application de la loi. Les codes procéduraux encadrent l’exercice de toute coercition par les autorités policières.
\article{}
Les procureurs généraux possèdent le statut de responsables administratifs.
\titre{De l'autorité judiciaire}
\Article{Justice}
...
\titre{De la modification et révision constitutionnelle}
\Article{Révision constitutionnelle}
\article{}
Toute modification ou révision constitutionnelle doit s’accompagner d’un vote à majorité au troisième quartile (à plus de ¾ en proportion de voix en faveur de ladite révision) des citoyens et d’une validation du projet de révision par le conseil constitutionnel selon les dispositions de l’article 5.2.
\article{}
Le dépôt d’une demande de révision constitutionnelle doit s’effectuer auprès du conseil constitutionnel, accompagnée de la spécification précise du point constitutionnel à réviser. L’organisation des débats et du vote est alors identique à celle précédant le vote d’une loi usuelle.
...
\article{}
En particulier les accords et traités internationaux ne peuvent être ratifiés ou approuvés qu'en vertu d'une loi.
...
\begin{itemize}
    ...
    \item les textes en ernestien non traduits en français, qui plus est si certains citoyens ont menti sur sa traduction en français
